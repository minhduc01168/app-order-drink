...
public class CreateDatabase extends SQLiteOpenHelper {
    ...
    public static String TB_NHANVIEN_FULLNAME = "FULLNAME";
    ...
    public void onCreate(SQLiteDatabase db) {
        String tbNHANVIEN = "CREATE TABLE " + TB_NHANVIEN + " ( " + TB_NHANVIEN_MANV + " INTEGER PRIMARY KEY AUTOINCREMENT, "
                + TB_NHANVIEN_TEDN + " TEXT UNIQUE, " + TB_NHANVIEN_FULLNAME + " TEXT," + TB_NHANVIEN_MATKHAU + " TEXT, " + TB_NHANVIEN_GIOITINH + " TEXT, "
