...
public class DangKyActivity extends AppCompatActivity implements View.OnClickListener{
    private EditText edTenDangNhap, edFullName,edMatKhau, edNgaySinh, edCMND;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (manhanvien != 0){
            ...
            edFullName.setText(nhanVienDTO.getFULLNAME());
    ...
    private void DongYThemNhanVien(){
        ...
        if (sTenDangNhap == null || sTenDangNhap.equals("")){
            ...
            nhanVienDTO.setFULLNAME(sFullName);
            ...
            } else if(spinQuyen.getSelectedItem().toString().equalsIgnoreCase("Admin")){// thêm
